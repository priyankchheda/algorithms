...
func TestMergeSortOptimized(t *testing.T) {
	...
	for _, table := range tables {
		...
		MergeSortOptimized(array1, aux, 0, len(array1)-1)
		sort.Ints(array2)
	...
	arrayRandom2 := make([]int, len(arrayRandom1))
	copy(arrayRandom2, arrayRandom1)
	auxRandom1 := make([]int, len(arrayRandom1))
	MergeSortOptimized(arrayRandom1, auxRandom1, 0, len(arrayRandom1)-1)
	sort.Ints(arrayRandom2)
...
func TestMergeSortBottomUp(t *testing.T) {
	...
	arrayRandom2 := make([]int, len(arrayRandom1))
	copy(arrayRandom2, arrayRandom1)
	MergeSortBottomUp(arrayRandom1)
	sort.Ints(arrayRandom2)
