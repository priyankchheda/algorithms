...
namespace Queue {
    ...
    */
     ...
     * @throws Queue::OverflowException if queue is full
     *      (item not enqueued).
    */
    template <typename T>
     ...
     * @throws Queue::UnderflowException if queue is empty
     *      (nothing to pop).
    */
    template <typename T>
    T Queue<T>::dequeue() {
     ...
     * @throws Queue::UnderflowException exception if queue is empty
     *      (nothing to peek).
    */
    template <typename T>
    T Queue<T>::peek() {
